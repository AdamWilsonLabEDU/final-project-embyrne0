...
-   PCA_script.R = To standardize the data points and to impliment the PCA. This also contains plots for visualizations. It also contains the k-means clustering from the reduced data points from the PCA.
...
![*PC1 vs. PC2 Scores*](images_plots/PC1 vs. PC2 Scatter Plot.png)
...
![*Scree Plot*](images_plots/Scree Plot.png)
...
![*Scree Plot*](images_plots/Centered Data.png)
...
![*Scree Plot*](images_plots/Scaled Data.png)
