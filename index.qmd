...
(Fig. 2) This Scree plot displays the variance explained by each principal component. The "scree" refers to the plot of eigenvalues, where the x-axis represents each principal component and the y-axis represents the proportion of variance explained by that component.
